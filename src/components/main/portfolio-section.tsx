...
export default function PortfolioSection() {
    ...
    const displayedItems = isExpanded ? portfolioItems : portfolioItems.slice(0, 3)
        ...
        >
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-blue-300 text-base md:text-lg max-w-2xl mx-auto">Real results for real clients</p>
                </motion.div>
                            ...
                            >
                                ...
                                <div className="absolute inset-0 p-6 flex flex-col justify-between">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-white/80 mb-3">Client: {item.client}</p>
                ...
                <div className="flex justify-center mt-8">
                    ...
                    >
                        <span className="text-white font-medium mr-2">{isExpanded ? "See Less" : "See More"}</span>
